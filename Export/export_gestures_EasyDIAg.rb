## Parameters
pri_col_name = 'gestures_asb'
# rel column has multiple coders
rel_col_name_list = %w[gestures_ejr gestures_mfs]
block_col_name = 'relblocks_gestures'
codes_to_check = %w(type directed_to_exp coordinated momresponse caregiver)
input_folder = '~/Desktop/gestures_opf'
