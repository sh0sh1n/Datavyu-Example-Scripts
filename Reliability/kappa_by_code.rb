...
## Parameters
primary_column_name = 'attempts'
reliability_column_name = 'rel_attempts'
blocks_columns = %w[task]
codes_to_check = %w[phase shape opening sf handlrb]
blank_value = ''
...
tables = {}
codes_to_check.map do |code|
  tables[code] = contingency_table(p_vals[code], r_vals[code])
  puts code
